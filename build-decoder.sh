...
emcc -msimd128 -flto src/decoder_core.c src/decoder_utils.c src/decoder_video.c src/decoder_audio.c src/decoder_subtitle.c src/decoder_track.c \
...
echo "Build complete! Output: build/decoder.js and build/decoder.wasm"
ls -lh build/decoder.*
